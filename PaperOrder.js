...
// Create a mock model if we're in mock mode
if (useMockData) {
  ...
  // Mock model
  class MockPaperOrder {
    constructor(data) {
      this._id = `mock_${++mockDb.counter}`;
    ...
    static async findByIdAndUpdate(id, update, options = {}) {
      const order = mockDb.orders.find(order => order._id === id);
